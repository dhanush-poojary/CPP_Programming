#include<iostream>//Insert at begining function  of linked list
...
int main(){
    ...
    ll.InsertATBegining(1000);//this will be inserted at the current linked list's at begining or head position
    ll.display();//for printing
